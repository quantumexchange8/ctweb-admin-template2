<nav class="navbar top-navbar" style="background-color: rgb(63 63 70);">
    <div class="container-fluid">
        <div class="navbar-left">
            <div class="navbar-btn">
                <a href="{{route('mypage.index')}}"><img src="../assets/images/currenttech_logo.svg" alt="Current Tech Logo" class="img-fluid logo" style="width: 180px;"></a>
