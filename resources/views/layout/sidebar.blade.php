<div id="left-sidebar" class="sidebar" style="background-color: rgb(63 63 70);">
    <div class="navbar-button">
        <a href="{{route('mypage.index')}}"><img src="../assets/images/currenttech_logo.svg" alt="Current Tech Logo" class="img-fluid logo" style="width: 180px; margin-top:10px; margin-left:10px;"></a>
